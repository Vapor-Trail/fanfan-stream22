 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var J;((J=window.HTMLSlotElement)===null||J===void 0?void 0:J.prototype.assignedElements)!=null;var Ue=Object.defineProperty,De=Object.getOwnPropertyDescriptor,Re=(i,e,t,n)=>{for(var s=n>1?void 0:n?De(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(s=(n?a(e,t,s):a(s))||s);return n&&s&&Ue(e,t,s),s};let ze=(i,e)=>{let t=0;i.forEach(n=>{n.isIntersecting&&(setTimeout(()=>{n.target.show()},t*100),t++)})};const Be=new IntersectionObserver(ze,{rootMargin:"-100px"});let ae=class extends p{static get styles(){return w`
      :host {
        display: block;
    ...
    `}show(){this.setAttribute("shown","")}connectedCallback(){super.connectedCallback(),this.style.setProperty("--rot",`${(Math.random()-.5)*4}deg`),Be.observe(this)}render(){return f`
      <div class="wrapper">
        <slot></slot>
      </div>
    `}};ae=Re([v("nida-card")],ae);var Je=Object.defineProperty,Ye=Object.getOwnPropertyDescriptor,O=(i,e,t,n)=>{for(var s=n>1?void 0:n?Ye(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(s=(n?a(e,t,s):a(s))||s);return n&&s&&Je(e,t,s),s};let x=class extends p{constructor(){super(),this._image=new Image,this._image.addEventListener("load",()=>{setTimeout(()=>{this._image.classList.remove("hidden")},10)})}static get styles(){return w`
			:host {
				display: contents;
			}
    ...
    `}};le=Qe([v("nida-chat")],le);var Xe=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,et=(i,e,t,n)=>{for(var s=n>1?void 0:n?Ze(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(s=(n?a(e,t,s):a(s))||s);return n&&s&&Xe(e,t,s),s};let de=class extends p{constructor(i){super(),this.original=i,this.position=null}static get styles(){return w`
      :host {
        position: fixed;
        top: 0;
        left: 0;
