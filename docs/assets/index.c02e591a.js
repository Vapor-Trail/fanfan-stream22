...
This is probably caused by illegal octal escape sequences.`),{_$litType$:n,strings:e,values:t}),g=wt(gt),P=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Ne=new WeakMap,j=(n,e,t)=>{var i,s;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const o=ot++,a=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let c=a._$litPart$;if(d==null||d({kind:"begin render",id:o,value:n,container:e,options:t,part:c}),c===void 0){const r=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:null;a._$litPart$=c=new R(e.insertBefore(O(),r),r,void 0,t!=null?t:{})}return c._$setValue(n),d==null||d({kind:"end render",id:o,value:n,container:e,options:t,part:c}),c};j.setSanitizer=rt,j.createSanitizer=pe,j._testOnlyClearSanitizerFactoryDoNotCallOrElse=dt;const E=N.createTreeWalker(N,129,null,!1);let x=W;const Tt=(n,e)=>{const t=n.length-1,i=[];let s=e===ge?"<svg>":"",o,a=I;for(let r=0;r<t;r++){const l=n[r];let m=-1,p,h=0,u;for(;h<l.length&&(a.lastIndex=h,u=a.exec(l),u!==null);)if(h=a.lastIndex,a===I){if(u[Ee]==="!--")a=Ce;else if(u[Ee]!==void 0)a=ke;else if(u[ie]!==void 0)Qe.test(u[ie])&&(o=new RegExp(`</${u[ie]}`,"g")),a=S;else if(u[ft]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else a===S?u[pt]===">"?(a=o!=null?o:I,m=-1):u[Ae]===void 0?m=-2:(m=a.lastIndex-u[mt].length,p=u[Ae],a=u[Ie]===void 0?S:u[Ie]==='"'?oe:se):a===oe||a===se?a=S:a===Ce||a===ke?a=I:(a=S,o=void 0);console.assert(m===-1||a===S||a===se||a===oe,"unexpected parse state B");const J=a===S&&n[r+1].startsWith("/>")?" ":"";s+=a===I?l+lt:m>=0?(i.push(p),l.slice(0,m)+me+l.slice(m)+b+J):l+b+(m===-2?(i.push(void 0),r):J)}const c=s+(n[t]||"<?>")+(e===ge?"</svg>":"");if(!Array.isArray(n)||!n.hasOwnProperty("raw")){let r="invalid template strings array";throw r=`
 ...
 */var he;((he=window.HTMLSlotElement)===null||he===void 0?void 0:he.prototype.assignedElements)!=null;var Ot=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,Mt=(n,e,t,i)=>{for(var s=i>1?void 0:i?Ht(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Ot(e,t,s),s};let Rt=(n,e)=>{let t=0;n.forEach(i=>{i.isIntersecting&&(setTimeout(()=>{i.target.show()},t*100),t++)})};const Lt=new IntersectionObserver(Rt,{rootMargin:"-100px"});let Oe=class extends y{static get styles(){return $`
    ...
    `}};Oe=Mt([w("nida-card")],Oe);var Ut=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,L=(n,e,t,i)=>{for(var s=i>1?void 0:i?Dt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Ut(e,t,s),s};let A=class extends y{constructor(){super(),this._image=new Image,this._image.addEventListener("load",()=>{setTimeout(()=>{this._image.classList.remove("hidden")},10)})}static get styles(){return $`
			:host {
				display: contents;
			}
		...
		`}connectedCallback(){super.connectedCallback()}attributeChangedCallback(n,e,t){super.attributeChangedCallback(n,e,t),n==="src"&&(this._image.src=t,this._image.width=+(this.width||0),this._image.height=+(this.height||0),this._image.loading="lazy",this._image.alt=this.alt||"",this._image.classList.add("hidden"))}render(){return g`${this._image}`}};L([B({type:String})],A.prototype,"src",2);L([B({type:String})],A.prototype,"alt",2);L([B({type:String})],A.prototype,"width",2);L([B({type:String})],A.prototype,"height",2);A=L([w("aui-lazyimage")],A);var jt=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,Vt=(n,e,t,i)=>{for(var s=i>1?void 0:i?zt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&jt(e,t,s),s};let He=class extends y{constructor(){super(...arguments),this.cards=[],this.init=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),window.addEventListener("cards",e=>{this.cards=e.detail});const n=document.querySelector(".page");if(n)n.addEventListener("scroll",()=>{!this.init&&this.cards.length>0&&(this.init=!0,this.requestUpdate())});else throw new Error("Something went wrong")}renderMedia(n){switch(n.type){default:return n.embed?g`<iframe
            src="${n.embed}"
            width="100%"
            height="280px"
            style="border: none;"
...
`,media:{src:"dist/media/1-Ng_eQTKIDPN-QDTGMvRzgUIy3N9h_D1.jpeg",type:"image/jpeg",embed:"https://drive.google.com/file/d/1-Ng_eQTKIDPN-QDTGMvRzgUIy3N9h_D1/preview"},name:""}],Le={showPage(){const n=document.querySelector(".page");n&&(n.removeAttribute("loading"),window.dispatchEvent(new CustomEvent("cards",{detail:Gt})))}},Ue=["Hey Nida!","Im sorry to remind you,","but today is your birthday! :O","To celebrate,","we decided to make a game for you.","jk","But look at this!"];var Qt=Object.defineProperty,Zt=Object.getOwnPropertyDescriptor,Xt=(n,e,t,i)=>{for(var s=i>1?void 0:i?Zt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Qt(e,t,s),s};let De=class extends y{constructor(){super(),this.index=-1,location.hash!=="#intro"&&(location.hash="",localStorage.setItem("into-finished","true"),Le.showPage(),this.remove())}static get styles(){return $`
      :host {
        display: block;
        position: fixed;
        top: 0;
...
`,` 
`).split(" "),i=[];for(let s of t)if(s=s.replace(/:/g,""),s in je)i.push(`<span class="emote"><img src="${je[s]}" alt="${s}" /></span>`);else{let o=s;for(let a of ln(s))o=o.replace(a[0],`<span class="emote">${a[0]}</span>`);i.push(o)}this.content=i.join(" "),this.requestUpdate()}render(){return g`
