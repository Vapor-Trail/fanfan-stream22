...
This is probably caused by illegal octal escape sequences.`),{_$litType$:n,strings:e,values:t}),g=wt(gt),x=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Ne=new WeakMap,D=(n,e,t)=>{var i,s;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const o=ot++,a=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let c=a._$litPart$;if(d==null||d({kind:"begin render",id:o,value:n,container:e,options:t,part:c}),c===void 0){const r=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:null;a._$litPart$=c=new R(e.insertBefore(O(),r),r,void 0,t!=null?t:{})}return c._$setValue(n),d==null||d({kind:"end render",id:o,value:n,container:e,options:t,part:c}),c};D.setSanitizer=rt,D.createSanitizer=pe,D._testOnlyClearSanitizerFactoryDoNotCallOrElse=dt;const E=N.createTreeWalker(N,129,null,!1);let P=W;const Tt=(n,e)=>{const t=n.length-1,i=[];let s=e===ge?"<svg>":"",o,a=A;for(let r=0;r<t;r++){const l=n[r];let m=-1,p,h=0,u;for(;h<l.length&&(a.lastIndex=h,u=a.exec(l),u!==null);)if(h=a.lastIndex,a===A){if(u[Ee]==="!--")a=ke;else if(u[Ee]!==void 0)a=Ce;else if(u[ie]!==void 0)Qe.test(u[ie])&&(o=new RegExp(`</${u[ie]}`,"g")),a=S;else if(u[ft]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else a===S?u[pt]===">"?(a=o!=null?o:A,m=-1):u[Ie]===void 0?m=-2:(m=a.lastIndex-u[mt].length,p=u[Ie],a=u[Ae]===void 0?S:u[Ae]==='"'?oe:se):a===oe||a===se?a=S:a===ke||a===Ce?a=A:(a=S,o=void 0);console.assert(m===-1||a===S||a===se||a===oe,"unexpected parse state B");const J=a===S&&n[r+1].startsWith("/>")?" ":"";s+=a===A?l+lt:m>=0?(i.push(p),l.slice(0,m)+me+l.slice(m)+b+J):l+b+(m===-2?(i.push(void 0),r):J)}const c=s+(n[t]||"<?>")+(e===ge?"</svg>":"");if(!Array.isArray(n)||!n.hasOwnProperty("raw")){let r="invalid template strings array";throw r=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(r)}return[Pe!==void 0?Pe.createHTML(c):c,i]};class H{constructor({strings:e,["_$litType$"]:t},i){this.parts=[];let s,o=0,a=0;const c=e.length-1,r=this.parts,[l,m]=Tt(e,t);if(this.el=H.createElement(l,i),E.currentNode=this.el.content,t===ge){const p=this.el.content,h=p.firstChild;h.remove(),p.append(...h.childNodes)}for(;(s=E.nextNode())!==null&&r.length<c;){if(s.nodeType===1){{const p=s.localName;if(/^(?:textarea|template)$/i.test(p)&&s.innerHTML.includes(b)){const h=`Expressions are not supported inside \`${p}\` elements. See https://lit.dev/msg/expression-in-${p} for more information.`;if(p==="template")throw new Error(h);z("",h)}}if(s.hasAttributes()){const p=[];for(const h of s.getAttributeNames())if(h.endsWith(me)||h.startsWith(b)){const u=m[a++];if(p.push(h),u!==void 0){const Ze=s.getAttribute(u.toLowerCase()+me).split(b),U=/([.?@])?(.*)/.exec(u);r.push({type:_e,index:o,name:U[2],strings:Ze,ctor:U[1]==="."?St:U[1]==="?"?Pt:U[1]==="@"?Et:F})}else r.push({type:be,index:o})}for(const h of p)s.removeAttribute(h)}if(Qe.test(s.tagName)){const p=s.textContent.split(b),h=p.length-1;if(h>0){s.textContent=k?k.emptyScript:"";for(let u=0;u<h;u++)s.append(p[u],O()),E.nextNode(),r.push({type:V,index:++o});s.append(p[h],O())}}}else if(s.nodeType===8)if(s.data===Ke)r.push({type:V,index:o});else{let h=-1;for(;(h=s.data.indexOf(b,h+1))!==-1;)r.push({type:bt,index:o}),h+=b.length-1}o++}d==null||d({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const i=N.createElement("template");return i.innerHTML=e,i}}function C(n,e,t=n,i){var s,o,a,c;if(e===x)return e;let r=i!==void 0?(s=t.__directives)===null||s===void 0?void 0:s[i]:t.__directive;const l=M(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==l&&((o=r==null?void 0:r._$notifyDirectiveConnectionChanged)===null||o===void 0||o.call(r,!1),l===void 0?r=void 0:(r=new l(n),r._$initialize(n,t,i)),i!==void 0?((a=(c=t).__directives)!==null&&a!==void 0?a:c.__directives=[])[i]=r:t.__directive=r),r!==void 0&&(e=C(n,r._$resolve(n,e.values),r,i)),e}class $t{constructor(e,t){this._parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var t;const{el:{content:i},parts:s}=this._$template,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:N).importNode(i,!0);E.currentNode=o;let a=E.nextNode(),c=0,r=0,l=s[0];for(;l!==void 0;){if(c===l.index){let m;l.type===V?m=new R(a,a.nextSibling,this,e):l.type===_e?m=new l.ctor(a,l.name,l.strings,this,e):l.type===be&&(m=new kt(a,this,e)),this._parts.push(m),l=s[++r]}c!==(l==null?void 0:l.index)&&(a=E.nextNode(),c++)}return o}_update(e){let t=0;for(const i of this._parts)i!==void 0&&(d==null||d({kind:"set part",part:i,value:e[t],valueIndex:t,values:e,templateInstance:this}),i.strings!==void 0?(i._$setValue(e,i,t),t+=i.strings.length-2):i._$setValue(e[t])),t++}}class R{constructor(e,t,i,s){var o;this.type=V,this._$committedValue=f,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=i,this.options=s,this.__isConnected=(o=s==null?void 0:s.isConnected)!==null&&o!==void 0?o:!0,this._textSanitizer=void 0}get _$isConnected(){var e,t;return(t=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&t!==void 0?t:this.__isConnected}get parentNode(){let e=v(this._$startNode).parentNode;const t=this._$parent;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");e=C(this,e,t),M(e)?e===f||e==null||e===""?(this._$committedValue!==f&&(d==null||d({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=f):e!==this._$committedValue&&e!==x&&this._commitText(e):e._$litType$!==void 0?this._commitTemplateResult(e):e.nodeType!==void 0?this._commitNode(e):ct(e)?this._commitIterable(e):this._commitText(e)}_insert(e,t=this._$endNode){return v(v(this._$startNode).parentNode).insertBefore(e,t)}_commitNode(e){var t;if(this._$committedValue!==e){if(this._$clear(),P!==W){const i=(t=this._$startNode.parentNode)===null||t===void 0?void 0:t.nodeName;if(i==="STYLE"||i==="SCRIPT"){let s="Forbidden";throw i==="STYLE"?s="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":s="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(s)}}d==null||d({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==f&&M(this._$committedValue)){const t=v(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=pe(t,"data","property")),e=this._textSanitizer(e),d==null||d({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=document.createTextNode("");this._commitNode(t),this._textSanitizer===void 0&&(this._textSanitizer=pe(t,"data","property")),e=this._textSanitizer(e),d==null||d({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){var t;const{values:i,["_$litType$"]:s}=e,o=typeof s=="number"?this._$getTemplate(e):(s.el===void 0&&(s.el=H.createElement(s.h,this.options)),s);if(((t=this._$committedValue)===null||t===void 0?void 0:t._$template)===o)d==null||d({kind:"template updating",template:o,instance:this._$committedValue,parts:this._$committedValue._parts,options:this.options,values:i}),this._$committedValue._update(i);else{const a=new $t(o,this),c=a._clone(this.options);d==null||d({kind:"template instantiated",template:o,instance:a,parts:a._parts,options:this.options,fragment:c,values:i}),a._update(i),d==null||d({kind:"template instantiated and updated",template:o,instance:a,parts:a._parts,options:this.options,fragment:c,values:i}),this._commitNode(c),this._$committedValue=a}}_$getTemplate(e){let t=Ne.get(e.strings);return t===void 0&&Ne.set(e.strings,t=new H(e)),t}_commitIterable(e){Ge(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let i=0,s;for(const o of e)i===t.length?t.push(s=new R(this._insert(O()),this._insert(O()),this,this.options)):s=t[i],s._$setValue(o),i++;i<t.length&&(this._$clear(s&&v(s._$endNode).nextSibling,i),t.length=i)}_$clear(e=v(this._$startNode).nextSibling,t){var i;for((i=this._$notifyConnectionChanged)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$endNode;){const s=v(e).nextSibling;v(e).remove(),e=s}}setConnected(e){var t;if(this._$parent===void 0)this.__isConnected=e,(t=this._$notifyConnectionChanged)===null||t===void 0||t.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class F{constructor(e,t,i,s,o){this.type=_e,this._$committedValue=f,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=s,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=f,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,t=this,i,s){const o=this.strings;let a=!1;if(o===void 0)e=C(this,e,t,0),a=!M(e)||e!==this._$committedValue&&e!==x,a&&(this._$committedValue=e);else{const c=e;e=o[0];let r,l;for(r=0;r<o.length-1;r++)l=C(this,c[i+r],t,r),l===x&&(l=this._$committedValue[r]),a||(a=!M(l)||l!==this._$committedValue[r]),l===f?e=f:e!==f&&(e+=(l!=null?l:"")+o[r+1]),this._$committedValue[r]=l}a&&!s&&this._commitValue(e)}_commitValue(e){e===f?v(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=P(this.element,this.name,"attribute")),e=this._sanitizer(e!=null?e:""),d==null||d({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),v(this.element).setAttribute(this.name,e!=null?e:""))}}class St extends F{constructor(){super(...arguments),this.type=yt}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=P(this.element,this.name,"property")),e=this._sanitizer(e),d==null||d({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===f?void 0:e}}const xt=k?k.emptyScript:"";class Pt extends F{constructor(){super(...arguments),this.type=vt}_commitValue(e){d==null||d({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==f),options:this.options}),e&&e!==f?v(this.element).setAttribute(this.name,xt):v(this.element).removeAttribute(this.name)}}class Et extends F{constructor(e,t,i,s,o){if(super(e,t,i,s,o),this.type=_t,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){var i;if(e=(i=C(this,e,t,0))!==null&&i!==void 0?i:f,e===x)return;const s=this._$committedValue,o=e===f&&s!==f||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,a=e!==f&&(s===f||o);d==null||d({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:o,addListener:a,oldListener:s}),o&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var t,i;typeof this._$committedValue=="function"?this._$committedValue.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$committedValue.handleEvent(e)}}class kt{constructor(e,t,i){this.element=e,this.type=be,this._$disconnectableChildren=void 0,this._$parent=t,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){d==null||d({kind:"commit to element binding",element:this.element,value:e,options:this.options}),C(this,e)}}const ae=window.litHtmlPolyfillSupportDevMode;ae==null||ae(H,R);((te=globalThis.litHtmlVersions)!==null&&te!==void 0?te:globalThis.litHtmlVersions=[]).push("2.2.6");globalThis.litHtmlVersions.length>1&&z("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var he;((he=window.HTMLSlotElement)===null||he===void 0?void 0:he.prototype.assignedElements)!=null;var Ot=Object.defineProperty,Mt=Object.getOwnPropertyDescriptor,Ht=(n,e,t,i)=>{for(var s=i>1?void 0:i?Mt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Ot(e,t,s),s};let Rt=(n,e)=>{let t=0;n.forEach(i=>{i.isIntersecting&&(setTimeout(()=>{i.target.show()},t*100),t++)})};const Lt=new IntersectionObserver(Rt,{rootMargin:"-100px"});let Oe=class extends y{static get styles(){return $`
      :host {
        display: block;
    ...
    `}};Oe=Ht([w("nida-card")],Oe);var Ut=Object.defineProperty,jt=Object.getOwnPropertyDescriptor,L=(n,e,t,i)=>{for(var s=i>1?void 0:i?jt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Ut(e,t,s),s};let I=class extends y{constructor(){super(),this._image=new Image,this._image.addEventListener("load",()=>{setTimeout(()=>{this._image.classList.remove("hidden")},10)})}static get styles(){return $`
			:host {
				display: contents;
			}
		...
		`}connectedCallback(){super.connectedCallback()}attributeChangedCallback(n,e,t){super.attributeChangedCallback(n,e,t),n==="src"&&(this._image.src=t,this._image.width=+(this.width||0),this._image.height=+(this.height||0),this._image.loading="lazy",this._image.alt=this.alt||"",this._image.classList.add("hidden"))}render(){return g`${this._image}`}};L([B({type:String})],I.prototype,"src",2);L([B({type:String})],I.prototype,"alt",2);L([B({type:String})],I.prototype,"width",2);L([B({type:String})],I.prototype,"height",2);I=L([w("aui-lazyimage")],I);var Dt=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,Vt=(n,e,t,i)=>{for(var s=i>1?void 0:i?zt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Dt(e,t,s),s};let Me=class extends y{constructor(){super(...arguments),this.cards=[],this.init=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),window.addEventListener("cards",e=>{this.cards=e.detail});const n=document.querySelector(".page");if(n)n.addEventListener("scroll",()=>{!this.init&&this.cards.length>0&&(this.init=!0,this.requestUpdate())});else throw new Error("Something went wrong")}renderMedia(n){switch(n.type){default:return n.embed?g`<iframe
            src="${n.embed}"
            width="100%"
            height="280px"
            style="border: none;"
    ...
    `}};Me=Vt([w("nida-cardlist")],Me);const Wt=["fanfJAM fanfJAM fanfJAM fanfJAM fanfJAM fanfJAM","Happy Streamerversary!","fanfJAM fanfDance fanfJAM","fanfDance fanfDance fanfDance","fanfJAM fanfJAM fanfJAM fanfJAM","fanfJAM fanfJAM fanfJAM fanfJAM fanfJAM","fanfDance fanfDance","fanfJAM fanfDance fanfJAM"];var Ft=Object.defineProperty,Bt=Object.getOwnPropertyDescriptor,Jt=(n,e,t,i)=>{for(var s=i>1?void 0:i?Bt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Ft(e,t,s),s};let He=class extends y{constructor(){super(...arguments),this.messages=[]}static get styles(){return $`
      :host {
        display: block;
        position: absolute;
        bottom: 120px;
    ...
    `}};He=Jt([w("nida-chat")],He);var qt=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,Kt=(n,e,t,i)=>{for(var s=i>1?void 0:i?Yt(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&qt(e,t,s),s};let Re=class extends y{constructor(n){super(),this.original=n,this.position=null}static get styles(){return $`
      :host {
        position: fixed;
        top: 0;
        left: 0;
